...
//				movesDiv.style.overflow = "hidden";
			...
			for(var i = 0; i < 8; i++) {
				...
				tr.style.height = (parseInt(this.opts['squareSize'].replace("px",""))+1).toString()+"px";

				var flip = (i % 2)?1:0;
				for(var j = 0; j < 8; j++) {
					var td = resetStyles(document.createElement("td"));

					td.style.height = (parseInt(this.opts['squareSize'].replace("px",""))+1).toString()+"px";
					td.style.width = (parseInt(this.opts['squareSize'].replace("px",""))+1).toString()+"px";
			...
			btnTd.align = 'center';
			btnTd.valign = 'middle';
			btnTd.style.padding = '10px 0 5px 0';
